...
CREATE SEQUENCE CLASS_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER CLASS_ID_TRG
...
CREATE SEQUENCE FOLDERS_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER FOLDERS_ID_TRG
...
CREATE SEQUENCE FILES_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER FILES_ID_TRG
...
CREATE SEQUENCE QUESTION_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER QUESTION_ID_TRG
BEFORE INSERT ON QUESTION
FOR EACH ROW
BEGIN
IF :NEW.ID IS NOT NULL THEN
  SELECT QUESTION_ID_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END IF;
END;
...
CREATE SEQUENCE TAG_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER TAG_ID_TRG
...
CREATE SEQUENCE TAGLIST_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER TAGLIST_ID_TRG
BEFORE INSERT ON TAGLIST
FOR EACH ROW
BEGIN
IF :NEW.ID IS NOT NULL THEN
  SELECT TAGLIST_ID_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END IF;
END;
...
CREATE SEQUENCE ANSWER_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER ANSWER_ID_TRG
BEFORE INSERT ON ANSWER
FOR EACH ROW
BEGIN
IF :NEW.ID IS NOT NULL THEN
  SELECT ANSWER_ID_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END IF;
END;
...
COMMENT ON COLUMN ANSWER.THUMPSUP is 'THUMBSUP';
...
CREATE SEQUENCE ANSWER_THUMBSUP_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER ANSWER_THUMBSUP_ID_TRG
BEFORE INSERT ON ANSWER_THUMBSUP
FOR EACH ROW
BEGIN
IF :NEW.ID IS NOT NULL THEN
  SELECT ANSWER_THUMBSUP_ID_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END IF;
END;
...
CREATE SEQUENCE QUESTION_THUMBSUP_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER QUESTION_THUMBSUP_ID_TRG
BEFORE INSERT ON QUESTION_THUMBSUP
FOR EACH ROW
BEGIN
IF :NEW.ID IS NOT NULL THEN
  SELECT QUESTION_THUMBSUP_ID_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END IF;
END;
